...
<div class="Sections">
    Voici à peu-près comment je vie mes années au cégep de Victoriaville : <br>
    <span class='glyphicon glyphicon-ok'> </span> Certaines session sont meilleurs que d'autres <br>
    <span class='glyphicon glyphicon-ok'> </span> Certains profs sont cools, et d'autres le sont moins, ... <br>
</div>
<?php
